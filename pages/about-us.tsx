  ...
  return (
    <div className={styles.main}>
      ...
      <p>
        ...
        dream career. That&apos;s why we&apos;ve created a platform that&apos;s
        accessible to anyone, regardless of their background or experience
        level. Our goal is to help job seekers stand out from the competition by
        providing them with the tools they need to create a standout CV.
      </p>
      <p>
        ...
        professional and eye-catching CV that showcases their unique skills and
        talents.
      </p>
      <p>
        ...
        industry trends, employer preferences, and best practices to ensure that
        the guidance we offer is both relevant and effective. By doing so, we
        empower our users to present themselves in the best possible light,
        increasing their chances of landing their dream job.
      </p>
      <p>
