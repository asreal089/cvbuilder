    ...
    <div className={styles.main}>
      <div className={styles.content}>
        ...
        <p>
          ...
          dream career. That&apos;s why we&apos;ve created a platform
          that&apos;s accessible to anyone, regardless of their background or
          experience level. Our goal is to help job seekers stand out from the
          competition by providing them with the tools they need to create a
          standout CV.
        </p>
        <p>
